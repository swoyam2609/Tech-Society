    ...
    <div className=" text-white p-4 py-10" style={{ background: "#0C0A0A" }}>
      <div className="flex flex-wrap justify-center pt-20">
        ...
        <div className="p-4">
          <img
            src={image1}
            alt="1"
            className="h-50 object-cover hover:scale-110 duration-300"
          />
        </div>
        <div className=" p-4">
          <img
      ...
      <div className="flex flex-wrap justify-center">
        ...
        <div className="w-full lg:w-1/2 p-4 ">
          <p className="text-[0.95rem] mt-2 opacity-70">
            Tincidunt elit magnis nulla facilisis sagittis is maecenas. Sapien
            nunced amet ultrices, dolores sit lorem ipsum is simply free text
            available in the market velit purus aliquet massa fringilla leo
            orci.Tincidunt elit magnis nulla facilisis sagittis is maecenas.
            Sapien nunced amet ultrices, dolores sit lorem ipsum is .ultrices,
            dolores
          </p>
        </div>
      </div>
